...
version = "1.0.0"
description = "mi-assistant-service"
...
dependencies {
  ...
  // Retrieval runs on pgvector through JdbcTemplate and generation goes through ModelGateway, so
  // no Spring AI auto-configuration is active by default. Adding
  // `spring-ai-starter-model-openai` plus `spring.ai.openai.*` is what switches
  // `app.mi.llm.provider` to `greennode`.
