...
public final class AppConstants {
  ...
  public static final String SERVICE_NAME = "memory-hook-service";
  public static final String SCHEMA = "memory";
  public static final String REDIS_PREFIX = "memory";
  public static final String CONSUMER_GROUP = "memory";
